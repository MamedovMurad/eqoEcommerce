                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-3 col-md-3 col-sm-6 footer-widget">
                            <div class="footer-widget__logo mb-20">
                                <a href="#"><img src="{{ asset('themeplate') }}/assets/images/logo/logo.svg" alt=""></a>
                            </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-12 col-md-12">
                            <span class="copyright-text text-center">&copy; 2022 Helendo. <a  href="https://hasthemes.com/" target="_blank">All Rights Reserved.</a></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="quickview-product-active mr-lg-5">
                                <a href="#" class="images">
                                    <img src="{{ asset('themeplate') }}/assets/images/product/2-570x570.webp" class="img-fluid" alt="">
                                </a>
                                <a href="#" class="images">
                                    <img src="{{ asset('themeplate') }}/assets/images/product/3-600x600.webp" class="img-fluid" alt="">
                                </a>
                                <a href="#" class="images">
                                    <img src="{{ asset('themeplate') }}/assets/images/product/4-768x768.webp" class="img-fluid" alt="">
                                </a>
                            </div>
                ...
                <ul class="minicart-list">
                    <li class="minicart-product">
                        ...
                        <a class="product-item_img">
                            <img class="img-fluid" src="{{ asset('themeplate') }}/assets/images/product/small/cart-01.webp" alt="Product Image">
                        </a>
                    ...
                    <li class="minicart-product">
                        <a class="product-item_remove" href="javascript:void(0)"><i class="icon-cross2"></i></a>
                        <a class="product-item_img">
                            <img class="img-fluid" src="{{ asset('themeplate') }}/assets/images/product/small/cart-02.webp" alt="Product Image">
                        </a>
                        <div class="product-item_content">
                    ...
                    <li class="minicart-product">
                        <a class="product-item_remove" href="javascript:void(0)"><i class="icon-cross2"></i></a>
                        <a class="product-item_img">
                            <img class="img-fluid" src="{{ asset('themeplate') }}/assets/images/product/small/cart-03.webp" alt="Product Image">
                        </a>
                        <div class="product-item_content">
    ...
    ============================================ -->
    <!-- Modernizer JS -->
    <script src="{{ asset('themeplate') }}/assets/js/vendor/modernizr-2.8.3.min.js"></script>

    <!-- jQuery JS -->
    <script src="{{ asset('themeplate') }}/assets/js/vendor/jquery-3.5.1.min.js"></script>
    <script src="{{ asset('themeplate') }}/assets/js/vendor/jquery-migrate-3.3.0.min.js"></script>

    <!-- Bootstrap JS -->
    <script src="{{ asset('themeplate') }}/assets/js/vendor/bootstrap.min.js"></script>

    <!-- Plugins JS (Please remove the comment from below plugins.min.js for better website load performance and remove plugin js files from avobe) -->

    <script src="{{ asset('themeplate') }}/assets/js/plugins/plugins.js"></script>
