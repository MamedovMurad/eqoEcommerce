...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="{{ asset('themeplate') }}/assets/images/favicon.ico">

    <!-- CSS
        ============================================ -->

    <link rel="stylesheet" href="{{ asset('themeplate') }}/assets/css/vendor/vendor.min.css">
    <link rel="stylesheet" href="{{ asset('themeplate') }}/assets/css/plugins/plugins.min.css">

    <!-- Main Style CSS -->
    <link rel="stylesheet" href="{{ asset('themeplate') }}/assets/css/style.min.css">
                            ...
                            <nav class="navigation-menu">
                                <ul class="justify-content-center">
                                    ...
                                    <li >
                                        ...
                                        <a href="{{route('news')}}"><span>Pages</span></a>
                                        <!-- multilevel submenu -->
                              {{--           <ul class="submenu">
