...
<body>
    ...
    <header class="header_area header_padding">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="top_right text-end">
                                <ul>
                                    ...
                                    <li class="language"><a href="#"><img src="{{ asset('themeplate') }}/assets/img/logo/language.png" alt="">en-gb<i class="ion-ios-arrow-down"></i></a>
                                        <ul class="dropdown_language">
                                            <li><a href="#"><img src="{{ asset('themeplate') }}/assets/img/logo/language.png" alt=""> English</a></li>
                                            <li><a href="#"><img src="{{ asset('themeplate') }}/assets/img/logo/language2.png" alt=""> Germany</a></li>
                                        </ul>
                                    </li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-3">
                        <div class="logo">
                            <a href="index.html"><img src="{{ asset('themeplate') }}/assets/img/logo/logo.png" alt=""></a>
                        </div>
                    </div>
        ...
        <div class="mini_cart">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="{{ asset('themeplate') }}/assets/img/s-product/product.jpg" alt=""></a>
                </div>
                <div class="cart_info">
            ...
            <div class="cart_item">
                <div class="cart_img">
                    <a href="#"><img src="{{ asset('themeplate') }}/assets/img/s-product/product2.jpg" alt=""></a>
                </div>
                <div class="cart_info">
                                    ...
                                    <li class="mega_items"><a href="shop.html">shop<i class="fa fa-angle-down"></i></a>
                                        <div class="mega_menu">
                                            ...
                                            <div class="banner_static_menu">
                                                <a href="shop.html"><img src="{{ asset('themeplate') }}/assets/img/bg/banner1.jpg" alt=""></a>
                                            </div>
                                        </div>
                                    </li>
