                ...
                <aside class="sidebar_widget">
                    <div class="widget_inner">
                        <div class="widget_list widget_filter">
                            ...
                            <form action="{{route('filter')}}"   id="filterProduct" >
                                ...
                                <div class="widget_list widget_categories">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <input value="{{$item->id}}" type="checkbox" name="category_ids[]">
                                            <a href="#">{{$item->translate(App::getLocale())->title}} {{-- (6) --}}</a>
                                ...
                                <div class="widget_list widget_categories">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <input value="{{$item->id}}" type="checkbox" name="brend_ids[]">
                                            <a href="#">{{$item->translate(App::getLocale())->title}}{{-- (6) --}}</a>
                                            <span class="checkmark"></span>
                                        </li>
                                        @endforeach
...
<!--shop  area end-->
 ...
 @section('js')
 <script src="{{ asset('themeplate') }}/assets/js/restapi.js"></script>
 @endsection